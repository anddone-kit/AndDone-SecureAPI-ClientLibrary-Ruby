...
# Unit tests for OpenapiClient::PageVendorResponseDTODataInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PageVendorResponseDTODataInner do
  let(:instance) { OpenapiClient::PageVendorResponseDTODataInner.new }

  describe 'test an instance of PageVendorResponseDTODataInner' do
    it 'should create an instance of PageVendorResponseDTODataInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::PageVendorResponseDTODataInner)
    end
  end
