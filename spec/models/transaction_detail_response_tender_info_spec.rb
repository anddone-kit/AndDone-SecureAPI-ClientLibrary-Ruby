...
# Unit tests for OpenapiClient::TransactionDetailResponseTenderInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::TransactionDetailResponseTenderInfo do
  let(:instance) { OpenapiClient::TransactionDetailResponseTenderInfo.new }

  describe 'test an instance of TransactionDetailResponseTenderInfo' do
    it 'should create an instance of TransactionDetailResponseTenderInfo' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::TransactionDetailResponseTenderInfo)
    end
  end
