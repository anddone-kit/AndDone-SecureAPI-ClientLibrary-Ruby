...
# Unit tests for OpenapiClient::VendorRequestDTO
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::VendorRequestDTO do
  let(:instance) { OpenapiClient::VendorRequestDTO.new }

  describe 'test an instance of VendorRequestDTO' do
    it 'should create an instance of VendorRequestDTO' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::VendorRequestDTO)
    end
  end
