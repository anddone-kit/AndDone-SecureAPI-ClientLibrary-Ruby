...
# Unit tests for OpenapiClient::VendorResponseDTO
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::VendorResponseDTO do
  let(:instance) { OpenapiClient::VendorResponseDTO.new }

  describe 'test an instance of VendorResponseDTO' do
    it 'should create an instance of VendorResponseDTO' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::VendorResponseDTO)
    end
  end
